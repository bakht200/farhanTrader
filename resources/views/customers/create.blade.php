<x-app-layout>
    ...
    <div class="mb-4">
        <nav class="text-sm text-gray-600">
            ...
            <span class="mx-2">></span>
            <span class="text-gray-900 font-medium">Create Customer</span>
        </nav>
    </div>
    ...
    <form method="POST" action="{{ route('customers.store') }}" class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="customer_type" name="customer_type" value="{{ old('customer_type') }}" maxlength="100"
        ...
        <div class="flex space-x-2">
            <button type="submit" class="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 rounded-md">Create Customer</button>
